...
\Description{\MarginText{2019\\(expected)}\textbf{Ph.D, Informatics}
  ...
  \noindent %
  Deep learning over programs. Developing machine learning methods for random program generation, compiler optimisations, and representative benchmarking. Applications for heterogeneous parallelism, testing, and adaptive performance tuning. To date: 4 publications, 3 invited talks, 5 posters, 4 conferences.%
}
