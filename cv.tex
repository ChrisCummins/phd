...
\Description{\MarginText{2018\\(expected)}\textbf{Ph.D, Informatics}
  ...
  \noindent %
  Deep learning over programs. Developing machine learning methods for random program generation, compiler optimisations, and representative benchmarking. Applications for heterogeneous parallelism and adaptive performance tuning. Best Paper \emph{CGO'17}.%
}
...
\Description{\MarginText{2014}\textbf{MEng Electronic Engineering \& Computer Science}
  ...
  \newline Thesis: \textit{Protein Isoelectric Point Database} (mark 90\%)
  \newline\vspace{-.8em}
