...
def test_sha1_file_empty():
  assert ("da39a3ee5e6b4b0d3255bfef95601890afd80709" ==
          crypto.sha1_file("lib/labm8/data/test/empty_file"))


def test_sha1_file_hello_world():
  assert ("09fac8dbfd27bd9b4d23a00eb648aa751789536d" ==
          crypto.sha1_file("lib/labm8/data/test/hello_world"))
...
def test_md5_file_empty():
  assert ("d41d8cd98f00b204e9800998ecf8427e" ==
          crypto.md5_file("lib/labm8/data/test/empty_file"))


def test_md5_file_hello_world():
  assert ("746308829575e17c3331bbcb00c0898b" ==
          crypto.md5_file("lib/labm8/data/test/hello_world"))
...
def test_sha256_hello_world():
  assert ("dffd6021bb2bd5b0af676290809ec3a53191dd81c7f70a4b28688a362182986f" ==
...
def test_sha256_empty_list():
  assert ("e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855" ==
          crypto.sha256_list())
  assert ("4f53cda18c2baa0c0354bb5f9a3ecbe5ed12ab4d8e11ba873c2f11161202b945" ==
          crypto.sha256_list([]))


def test_sha256_list():
  assert ("be3d036085587af9522a8358dd1d09ba2b0ec63db92a62d28cf00dfcaeb25ca1" ==
