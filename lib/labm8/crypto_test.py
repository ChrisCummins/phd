...
def test_md5_file_empty(self):
  assert ("d41d8cd98f00b204e9800998ecf8427e" ==
          crypto.md5_file("tests/data/empty_file"))


def test_md5_file_hello_world(self):
  assert ("746308829575e17c3331bbcb00c0898b" ==
          crypto.md5_file("tests/data/hello_world"))
