...
\begin{figure}
	\centering %
	\subfloat[Config $5\pm$ segementation fault in vectorizer pass.]{%
	...
	\subfloat[Config $10\pm$ compiler assertion when global size > 1.]{%
		\noindent\mbox{\parbox{\columnwidth}{%
	...
	\subfloat[Configs $1\pm$ and $2\pm$ segementation fault.]{%
		\noindent\mbox{\parbox{\columnwidth}{%
				% bug-reports/CLgenResults/segfaults/bug-report-nvidia-561489.c
...
\begin{figure}
	\centering %
	\subfloat[Config $3\pm$ assertion during code generation for storing pointer values.]{%
		\noindent\mbox{\parbox{\columnwidth}{%
	...
	\subfloat[Config $3\pm$ assertion during code generation for scalar types.]{%
		\noindent\mbox{\parbox{\columnwidth}{%
