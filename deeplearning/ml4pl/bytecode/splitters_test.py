...
def test_GetTrainValTestGroups_group_ratios(db_512: bytecode_database.Database):
  groups = splitters.GetTrainValTestGroups(db_512, train_val_test_ratio=[2, 1, 1])
...
def test_GetPoj104BytecodeGroups_group_names(db_poj104: bytecode_database.Database):
  groups = splitters.GetPoj104BytecodeGroups(db_poj104)
  assert set(groups.keys()) == {'train', 'val', 'test'}


def test_GetPoj104BytecodeGroups_group_sizes(db_poj104: bytecode_database.Database):
  groups = splitters.GetPoj104BytecodeGroups(db_poj104)
...
def test_GetPoj104BytecodeGroups_unique_ids(db_poj104: bytecode_database.Database):
  groups = splitters.GetPoj104BytecodeGroups(db_poj104)
