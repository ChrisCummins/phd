...
@test.Fixture(scope="function")
def wiki_without_subexpressions() -> programl_pb2.ProgramGraphProto:
...
@test.Fixture(scope="function")
def wiki_with_commutativity() -> programl_pb2.ProgramGraphProto:
...
def test_GetExpressionSets_wiki(wiki: programl_pb2.ProgramGraphProto):
  expressions = subexpressions.GetExpressionSets(
    programl.ProgramGraphProtoToNetworkX(wiki)
  )
...
def test_GetExpressionSets_wiki_without_subexpressions(
  wiki_without_subexpressions: programl_pb2.ProgramGraphProto,
):
  expressions = subexpressions.GetExpressionSets(
    programl.ProgramGraphProtoToNetworkX(wiki_without_subexpressions)
  )
  assert sorted(expressions) == [
    {8},
    {9},
...
def test_GetExpressionSets_wiki_with_commutativity(
  ...
  wiki_with_commutativity: programl_pb2.ProgramGraphProto,
):
  ...
  assert subexpressions.GetExpressionSets(
    ...
    programl.ProgramGraphProtoToNetworkX(wiki_with_commutativity)
  )


def test_MakeSubexpressionsGraphs_wiki(wiki: programl_pb2.ProgramGraphProto):
