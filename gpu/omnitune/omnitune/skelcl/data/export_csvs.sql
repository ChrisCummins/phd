...
SELECT * FROM kernel_lookup;
.out "devices.csv"
SELECT * FROM devices;
.out "device_lookup.csv"
SELECT * FROM device_lookup;
.out "datasets.csv"
SELECT * FROM datasets;
.out "dataset_lookup.csv"
SELECT * FROM dataset_lookup;
.out "params.csv"
SELECT * FROM params;
.out "runtimes.csv"
...
SELECT * FROM runtime_regression_results;
.out "runtime_classification_results.csv"
SELECT * FROM runtime_classification_results;
.out "speedup_regression_results.csv"
SELECT * FROM speedup_regression_results;
.out "speedup_classification_results.csv"
SELECT * FROM speedup_classification_results;
