...
\diff{%
Compilers, which play an essential role in extracting performance, have changed little in the last few decades. They comprise a front-end, back-end 
... each part requires tuning ...
Currently, each architecture requires extensive hand tuning by experts to extract good performance.
... rise of GPGPU, FPGA~\cite{Misra2010}, ASICs~\cite{Misra2010,Jouppi2017}.
%
}
