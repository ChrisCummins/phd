...
that of automatic parallelism, where the goal is to develop
...
enabling optimised multi-grid programs~\cite{Chan2009}, with the wider
...
a lack of common, diverse benchmarks and data sets; a lack of common
...
data and related artefacts across the internet. In addition to sharing
...
generate codes which trigger bugs. There are two main approaches: \emph{program
	generation}, where inputs are synthesised from scratch; and \emph{program
...
clearly defined behaviour but very unlikely functionality, increasing the chances
...
generator. Similarly to CSmith, EMI favours very long test programs.
