...
This chapter provides a brief and non-exhaustive overview of the techniques and theory used in this thesis. First Section~\ref{sec:background-terminology} defines terminology. Then Sections~\ref{sec:background-machine-learning} and~\ref{sec:evaluation-techniques} describe the machine learning and evaluation techniques used in this thesis, respectively. Section~\ref{sec:programming-heterogeneous-systems} provides an overview of heterogeneous programming. Finally Section~\ref{sec:background-summary} concludes.
...
Decision trees are popular and low overhead form of classification. Implementations can be as simple and efficient as a set of nested conditional statements.
