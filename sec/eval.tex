...
Many of the causes can be attributed to improper or missing error handling.
...
\cc{Intel pass \emph{X86 DAG->DAG Instruction Selection}}
...
\cc{Intel pass \emph{Intel OpenCL Barrier}}
