...
Occasionally incorrect program semantics will go undetected. Both Figures~\ref{lst:intel-gt2-double-assertion} and~\ref{lst:beignet-scalarize-insert} cause failures during code generation.

% CLgen result ID 994
% TODO: Testbed $3\pm$ assertion in \emph{gbe::GenEncoder::handleDouble}

\paragraph{Parser Failures} %
Parser development is a mature and well understood practice. To our surprise, we uncovered parser errors. The following three code samples each induce crash errors during parsing of compound statements in Testbeds $5\pm$ and $7\pm$:
