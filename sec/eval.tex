...
The results emphasize that compiler validation is a moving target. Every change and feature addition has the potential to introduce regressions or new failure cases. \cc{If we could use this to leverage the case for low cost fuzzer development, I think this would be a nice closer.}
