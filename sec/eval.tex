...
\begin{figure}
  \centering %
  \subfloat[Testbeds $3\pm$ assertion \emph{storing/loading pointers only support private array} during code generation.]{%
...
Of the build crashes, 68\% failed silently, and the remainder were caused by a single assertion  pointer assignment assertion for which DeepSmith generated a 4 line test case in Figure~\ref{}. DeepSmith also generated silent build crashes, but with an average line count of XX, versus CLSmith's line count of XX.
