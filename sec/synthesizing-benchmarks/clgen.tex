...
\lstinputlisting[%
  ...
  language={C},%
  caption={%
    [The \emph{shim} header file for compiling OpenCL from GitHub]An overview of the \emph{shim} header file, providing inferred type aliases and constants for compiling OpenCL files taken on GitHub.%
  }%
