...
\begin{figure}
  ...
  \subfloat[][AMD Tahiti 7970]{%
    \includegraphics[width=1.37\textwidth,angle=90]{img/ex1-A}%
    \label{fig:npb-amd}}%
  \subfloat[][NVIDIA GTX 970]{%
    \includegraphics[width=1.37\textwidth,angle=90]{img/ex1-B}%
...
\begin{figure}
  \centering%
  \includegraphics[width=1.45\textwidth,angle=90]{img/ex2}%
