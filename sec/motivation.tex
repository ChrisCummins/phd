...
\begin{lstlisting}
__kernel void foo(__global double* a) {
...
We motivate the case for compiler fuzzing through deep learning using three example of bugs found using DeepSmith which cannot be .
