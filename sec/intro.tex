...
We present a novel, data-driven approach to the generation of random programs for compile fuzzing.

By design, the grammar-based approach specifically targets the compiler middle-end. Prior work \cite{McKeeman1998}



Our implementation, DeepSmith, 
we mine from open source code
we do not guarantee 
