...
\begin{table*}[t!]
  ...
  \caption{%
    OpenCL systems and the number of bug reports submitted to date. For each system, two testbeds are created, one with compiler optimizations, the other without. \factcheck{bug reports column}%
  }
  \label{tab:platforms}
\end{table*}
