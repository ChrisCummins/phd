...
\paragraph{\DeepTune Configuration} Figure~\ref{fig:nn}b shows the neural network configuration. We use the OpenCL kernel as input, and directly predict the coarsening factor. % We do not use the cascading binary model of Magni \emph{et al.}
