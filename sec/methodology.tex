...
\begin{table*}[t!]
  ...
  \caption{%
    OpenCL systems, the time spent in automated testing, and the number of bug reports submitted to date. \cc{refresh bugs submitted}%
  }
  \label{tab:platforms}
\end{table*}
