...
% TODO: 10\% of cases where DeepTune degrades performance.

\begin{figure}
  \centering %
  \subfloat[][AMD Tahiti 7970]{%
  	\includegraphics[width=1.25\textwidth,angle=270]{img/cgo-speedup-amd}%
  	\label{fig:cgo-speedup-amd}}%
  \subfloat[][NVIDIA GTX 970]{%
  	\includegraphics[width=1.25\textwidth,angle=270]{img/cgo-speedup-nvidia}%
  	\label{fig:cgo-speedup-nvidia}}%
  % \includegraphics[width=1.25\textwidth,angle=270]{img/cgo-speedup}%
