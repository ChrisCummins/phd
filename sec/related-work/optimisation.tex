...
\todo[inline]{Compiler phase ordering~\cite{Ashouri2017}}
...
\todo[inline]{Learning using an unbounded vocabulary~\cite{Cvitkovic2018a}.}
...
Code summarisation~\cite{Allamanis2016}.

Comment generation~\cite{Wong2013}.
...
There is an increasing interest in mining source code repositories at large scale~\cite{Allamanis2013a,White2015a,Bird2009}. Previous studies have involved data mining of GitHub to analyse software engineering practices~\cite{Wu2014,Guzman2014,Baishakhi2014a,Vasilescu2015}, for example code generation~\cite{Zhang2015a}, and code completion~\cite{Raychev2014}. However, no work so far has exploited mined source code for benchmark generation. This work is the first to do so.
