...
\paragraph{SPE} \cec{TODO: Skeletal program enumeration~\cite{Zhang2016b}}. Bounded guarantees of correctness.


\paragraph{Csmith}  Grammar-based \emph{fuzz testers} have been developed for C~\cite{Yang2011} and OpenCL~\cite{Lidbury2015a}. Both tools require test case reduction (\cite{Regehr2012a} and~\cite{Pflanzer2016}, respectively). \cec{TODO: study, write up}.
...
Syntactic level modeling has been shown useful for identifying optimization characteristics~\cec{[PACT'17]}.
