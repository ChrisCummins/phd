...
%\begin{figure}
%  \centering %
%  \subfloat[][Crash error rate]{%
%    \includegraphics[width=.9\columnwidth]{build/img/clang-crashes}%
%    \label{fig:clang-crash-rate}}\\%
%  \subfloat[][Distinct crashes]{%
%    \includegraphics[width=.9\columnwidth]{build/img/clang-num-crashes}%
%    \label{fig:clang-distinct-crashes}}%
%  \caption{%
%    Clang frontend errors from 75k DeepSmith programs using recent LLVM releases.% 2 years of development has lead to a tenfold decrease in crash rate.
%  }%
%  \label{fig:clangs} %
%\end{figure}
...
\begin{figure}
  \centering %
  \includegraphics[width=\columnwidth]{build/img/clang-crashes}%
  \caption{%
    Clang frontend errors from 75k DeepSmith programs using recent LLVM releases.% 2 years of development has lead to a tenfold decrease in crash rate.
  }%
  \label{fig:clangs} %
