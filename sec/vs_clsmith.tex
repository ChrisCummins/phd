...
In this section we compare our approach against CLSmith, the state-of-the-art in OpenCL compiler testing. For each of the 10 OpenCL configurations, we run the 48 consecutive
