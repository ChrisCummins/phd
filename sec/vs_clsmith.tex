...
\begin{figure}
  ...
  \caption{Crash rate and distinct of Clang frontend over 75k DeepSmith kernels using recent LLVM releases. 2 years of development has lead to a tenfold decrease in crash rate.}%
  \label{fig:npb} %
\end{figure}
