...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.26/install-cpu.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.26/install-opencl.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.26/install-cuda.sh)"
...
.. |Documentation Status| image:: https://img.shields.io/badge/docs-0.0.26-brightgreen.svg?style=flat
   :target: http://chriscummins.cc/clgen/

.. |Release Version| image:: https://img.shields.io/badge/release-0.0.26-blue.svg?style=flat
