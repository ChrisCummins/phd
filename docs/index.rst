...
::
    ...
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-deps.sh | bash
...
::
    ...
    (clgen)$ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-cpu.sh | bash
...
::
    ...
    (clgen)$ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-opencl.sh | bash
...
::
    ...
    (clgen)$ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-cuda.sh | bash
...
::
    ...
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-cpu.sh | bash
...
::
    ...
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-opencl.sh | bash
...
::
    ...
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.2.18/install-cuda.sh | bash
...
.. |Documentation Status| image:: https://img.shields.io/badge/docs-0.2.18-brightgreen.svg?style=flat
   :target: http://chriscummins.cc/clgen/
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.2.18-blue.svg?style=flat
