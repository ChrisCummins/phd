...
::
    ...
    $ sudo bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.18/install-cpu.sh)"
...
::
    ...
    $ sudo bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.18/install-opencl.sh)"
...
::
    ...
    $ sudo bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.18/install-cuda.sh)"
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.18-blue.svg?style=flat
