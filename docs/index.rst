...
::
    ...
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.3.9.dev0/install-deps.sh | bash
...
::
    ...
    (clgen)$ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.3.9.dev0/install-cuda.sh | bash
    # CPU only:
    (clgen)$ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.3.9.dev0/install-cpu.sh | bash
...
::
    ...
    # if you have an NVIDIA GPU with CUDA 8.0 and cuDNN:
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.3.9.dev0/install-cuda.sh | bash
    # CPU only:
    $ curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.3.9.dev0/install-cpu.sh | bash
...
.. |Documentation Status| image:: https://img.shields.io/badge/docs-0.3.9.dev0-brightgreen.svg?style=flat
   :target: http://chriscummins.cc/clgen/
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.3.9.dev0-blue.svg?style=flat
