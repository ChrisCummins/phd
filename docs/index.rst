...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.22/install-cpu.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.22/install-opencl.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.22/install-cuda.sh)"
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.22-blue.svg?style=flat
