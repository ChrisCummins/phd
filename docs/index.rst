...
::
    ...
    $ wget https://github.com/ChrisCummins/clgen/archive/0.0.12.tar.gz -O clgen-0.0.12.tar.gz
    $ tar xf clgen-0.0.12.tar.gz
    $ cd clgen-0.0.12
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.12-blue.svg?style=flat
