...
::
    ...
    $ wget https://github.com/ChrisCummins/clgen/archive/0.0.11.tar.gz -O clgen-0.0.11.tar.gz
    $ tar xf clgen-0.0.11.tar.gz
    $ cd clgen-0.0.11
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.11-blue.svg?style=flat
