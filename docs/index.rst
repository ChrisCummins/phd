...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.25/install-cpu.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.25/install-opencl.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.25/install-cuda.sh)"
...
.. |Documentation Status| image:: https://img.shields.io/badge/docs-0.0.25-brightgreen.svg?style=flat
   :target: http://chriscummins.cc/clgen/

.. |Release Version| image:: https://img.shields.io/badge/release-0.0.25-blue.svg?style=flat
