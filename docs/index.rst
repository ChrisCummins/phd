...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.15/install.sh)"
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.15-blue.svg?style=flat
