...
::
    ...
    $ wget -O clgen-0.0.7.tar.gz https://github.com/ChrisCummins/clgen/archive/0.0.6.tar.gz
    $ tar xf clgen-0.0.7.tar.gz
    $ cd clgen-0.0.7
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.7-blue.svg?style=flat
