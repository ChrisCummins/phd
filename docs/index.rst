...
::
    ...
    $ wget -O clgen-0.0.9.tar.gz https://github.com/ChrisCummins/clgen/archive/0.0.9.tar.gz
    $ tar xf clgen-0.0.9.tar.gz
    $ cd clgen-0.0.9
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.9-blue.svg?style=flat
