...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.23/install-cpu.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.23/install-opencl.sh)"
...
::
    ...
    $ bash -c "$(curl -s https://raw.githubusercontent.com/ChrisCummins/clgen/0.0.23/install-cuda.sh)"
...
.. |Release Version| image:: https://img.shields.io/badge/release-0.0.23-blue.svg?style=flat
