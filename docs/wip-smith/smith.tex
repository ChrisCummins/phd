...
is 14. Of those, the majority (74\%) come from four benchmark suites:
...
\begin{figure}[t]
  ...
  \caption{%
    Origins of benchmark kernels used in research papers. The 4 most
    frequently used benchmark suites account for 74\% of all kernels.%
  }
...
\begin{table*}% tab:platforms
  ...
  \begin{tabular}{l c c c c}%C{1.65cm} C{1.65cm} C{1.65cm} C{1.65cm}}
    ...
    & \textbf{Intel x} & \textbf{AMD Tahiti 7970} & \textbf{Intel x} & \textbf{AMD HD 5450} \\
    \midrule
    \textbf{Frequency} & x GHz & 1000 MHz & x GHz & 650 MHz \\
    \textbf{\#. Cores} & x & x & 8 & 80 \\
    \textbf{Memory} & 8 GB & 3 GB & x & x \\
    \textbf{Throughput} & x GFLOPS & x GFLOPS & x GFLOPS & 104 GFLOPS
    \\
    % \midrule
