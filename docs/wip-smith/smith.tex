...
architecture of Recurrent Neural Network~\cite{Mikolov2015}. LSTMs are
proving to be a powerful learning tool with applications from speech
recognition to image captioning. LSTMs for language
...
%   size_of_input = 94
%   size_of_output = 2048
Our LSTM model has 17 million parameters, from a network of 3 layers
of 2048 nodes. We trained the model using backpropagation through time
gradient-descent for 50 epochs, using an initial learning rate of
...
Vocabulary size 96. Training size 33 million tokens. Learned model 648
MB.
...
\begin{table}% tab:%benchmarks
  ...
  \begin{tabular}{l r r r}
    ...
    \midrule
    \textbf{NPB (SNU~\cite{Seo2011})} & 1.0.3 & x & x \\
