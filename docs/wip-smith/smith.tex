...
We surveyed the benchmarking methodologies of XXX publications in the
field of GPU optimisation, finding that only XXX benchmarks account
for XXX\% of all results.
% Conferences:
%
% CGO 2016
% CGO 2015
...
\begin{tabular}{l r R{2cm} R{2cm}}
  ...
  \textbf{PolyBench} & 1.0 & 30 & x \\
  \textbf{Rodinia} & 3.1 & x & x \\
  \textbf{AMD SDK} & 3.0 & x & x \\
  \textbf{NVIDIA SDK} & 4.2 & 35 & x \\
  \textbf{SHOC} & 1.1.5 & 53 & x \\
  \textbf{Synthetic} & - & - & x \\
  \bottomrule
\end{tabular}
\caption{%
