...
%
With 18 lines of code we extended our program generator to a second  language, uncovering crashes in Solidity compilers in 12 hours of automated testing.
...
% \hl{Is it worth talking about the Solidity work?}\am{To demonstrate the portability of our approach we also undertook an initial experiment applying DeepSmith to the Solidity language, uncovering several compiler crashes.}
