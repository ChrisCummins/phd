...
\Description{%
  ...
  \vspace{.5em}\\ \noindent
  % Description.
  Created a representative benchmark of Google's Protocol Buffer usage. Working in the Google Wide Profiling team to synthesise benchmarks for Google compute. The project involved company-wide workload characterization through to datacentre-scale low level performance analysis of profiles and hardware counters.%
}
