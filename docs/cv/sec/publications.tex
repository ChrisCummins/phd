...
% Conference / Journal.
Distinguished Paper Award ISSTA'18 (28\% acceptance rate), Amsterdam, Netherlands.\@  % 112 submissions, 31 accepted.
\newline\vspace{-1em}\\ \noindent
% Description.
...
C.\ \textsc{Cummins}, P.\ \textsc{Petoumenos}, A.\ \textsc{Murray}, H.\ \textsc{Leather}. %
% Title.
\textbf{DeepSmith: Compiler Fuzzing through Deep Learning} (extended abstract). %
% Conference / Journal.
ACACES'18, Fiuggi, Italy.\@ %
\newline\vspace{-1em}\\ \noindent
% Description.
A novel approach to compiler fuzzing which offers to dramatically reduce the cost and human effort required to engineer a random program generator.%
}
