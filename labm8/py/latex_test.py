...
def test_write_table_body_headers():
  assert (
    ...
    "1 & foo\\\\\n"
    "2 & bar\\\\\n"
    == latex.write_table_body(((1, "foo"), (2, "bar")), headers=("A", "B"),)
  )
...
def test_write_table_body_headers_no_hline():
  assert (
    ...
    "2 & bar\\\\\n"
    == latex.write_table_body(
      ((1, "foo"), (2, "bar")), headers=("A", "B"), hline_after_header=False,
    )
  )
...
def test_write_table_body_headers_no_fmt():
  assert (
    ...
    "2 & bar\\\\\n"
    == latex.write_table_body(
      ((1, "foo"), (2, "bar")), headers=("A", "B"), header_fmt=lambda x: x,
    )
  )
...
def test_write_table_body_hlines():
  assert (
    ...
    "1 & foo\\\\\n"
    "2 & bar\\\\\n"
    == latex.write_table_body(((1, "foo"), (2, "bar")), hline_before=True,)
  )
  assert (
    "1 & foo\\\\\n"
    "2 & bar\\\\\n"
    "\\hline\n"
    == latex.write_table_body(((1, "foo"), (2, "bar")), hline_after=True,)
  )
