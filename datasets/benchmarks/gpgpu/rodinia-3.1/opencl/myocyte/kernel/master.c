...
void master(fp timeinst, fp *initvalu, fp *parameter, fp *finavalu, fp *com,
  ...
  error = CECL_WRITE_BUFFER(command_queue, d_params, 1, 0, d_params_mem,
  ...
  CECL_SET_KERNEL_ARG(kernel, 0, sizeof(int), (void *)&timeinst);
  CECL_SET_KERNEL_ARG(kernel, 1, sizeof(cl_mem), (void *)&d_initvalu);
  CECL_SET_KERNEL_ARG(kernel, 2, sizeof(cl_mem), (void *)&d_finavalu);
  CECL_SET_KERNEL_ARG(kernel, 3, sizeof(cl_mem), (void *)&d_params);
  CECL_SET_KERNEL_ARG(kernel, 4, sizeof(cl_mem), (void *)&d_com);

  //====================================================================================================100
  //	KERNEL
  //====================================================================================================100

  error = CECL_ND_RANGE_KERNEL(command_queue, kernel, 1, NULL, global_work_size,
  ...
  error = CECL_READ_BUFFER(command_queue, d_com, CL_TRUE, 0, d_com_mem, com, 0,
                           NULL, NULL);
  if (error != CL_SUCCESS) fatal_CL(error, __LINE__);
