...
pytest_plugins = ["programl.test.py.plugins.llvm_ir"]


LLVM_IR_GRAPHS = bazelutil.DataArchive("phd/programl/test/data/llvm_ir_graphs")
...
def llvm_program_graph_nx(
  llvm_program_graph: program_graph_pb2.ProgramGraph,
) -> nx.MultiDiGraph:
  """A test fixture which yields a networkx graph constructed from LLVM-IR."""
  return nx_format.ProgramGraphToNetworkX(llvm_program_graph)
