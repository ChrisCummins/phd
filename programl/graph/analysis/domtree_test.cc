...
class DomtreeAnalysisTest : public labm8::Test {
 public:
  DomtreeAnalysisTest() {
    {
...
TEST_F(DomtreeAnalysisTest, AnnotateG1FromRootA) {
  DomtreeAnalysis analysis(g1_);
  analysis.Init();
...
TEST_F(DomtreeAnalysisTest, AnnotateG2FromRootA) {
  DomtreeAnalysis analysis(g2_);
  analysis.Init();
  ProgramGraphFeatures f;
