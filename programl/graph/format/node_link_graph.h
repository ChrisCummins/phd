...
[[nodiscard]] Status NodeLinkGraphToProgramGraph(const json& dict,
                                                 ProgramGraph* graph);
...
// Helpers for converting from JSON node link graph to program graph.
[[nodiscard]] Status CreateGraphMessages(const json& graphDict,
                                         ProgramGraph* graph);
[[nodiscard]] Status CreateNodeMessages(const json& nodes, ProgramGraph* graph);
[[nodiscard]] Status CreateEdgeMessages(const json& links, ProgramGraph* graph);
