...
\begin{abstract}
  ...
  with machine learning offer promising performance benefits in these
  ...
  devices, supporting a collective approach to performance tuning.

  We demonstrate the practicality of OmniTune in a case study of the
