...
Compilers should always produce correct code for valid inputs and meaningful errors for invalid inputs. Failure to do so can hinder software development or even cause catastrophic runtime errors. Due to the complexity of modern compilers, properly testing them is hard. Manually assembled test-suites cannot cover the enormous range of possible inputs. Random program generators can but they require extensive development effort and they are limited 
