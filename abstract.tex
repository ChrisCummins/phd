...
We extend the state of the art in compiler test-case generation, automatically exposing bugs in compilers which are likely to arise from real world use cases, in a way which is not possible using existing techniques. In an empirical evaluation of 9 OpenCL implementations, we discover bugs in all of them, submitting XX bug reports to commercial and open source OpenCL implementations.
\end{abstract}
