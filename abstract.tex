\begin{abstract}
Compilers should produce correct code for valid inputs, and produce meaningful errors for invalid inputs. Testing these properties has lead to tools like CSmith.
