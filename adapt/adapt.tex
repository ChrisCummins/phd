...
\preprintfooter{ADAPT workshop paper draft}   % 'preprint' option specified.
...
\title{Autotuning Stencil Codes with Algorithmic Skeletons}
...
\item Section~\ref{sec:conclusions} contains concluding remarks, a
