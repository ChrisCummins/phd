      ...
      proto = deepsmith_pb2.Testcase(
        ...
        profiling_events=[
          deepsmith_pb2.ProfilingEvent(
            ...
            event_start_epoch_ms=dateutil.MillisecondsTimestamp(program_date),
          ),
        ],
      )
      with open(
        proto_dir / "opencl" / "testcases" / str(testcase_id), "wb"
      ) as f:
...
""",
    ...
    for row in cursor:
      ...
      testbed = deepsmith_pb2.Testbed(
        toolchain="opencl", name=testbed_name, opts=testbed_opts,
      )
      ...
      proto = deepsmith_pb2.Result(
        ...
        profiling_events=[
          deepsmith_pb2.ProfilingEvent(
            ...
            event_start_epoch_ms=dateutil.MillisecondsTimestamp(result_date),
          ),
        ],
      )
