...
flags.DEFINE_string('model_path', None, 'Directory to save model files to.')
...
flags.DEFINE_integer('num_layers', 2, 'The number of LSTM layers.')
...
flags.DEFINE_integer('seed', None, 'Random seed value.')
