...
def DirContainsProtos(data_path: str, proto_class):
...
def test_clone_lists_are_valid():
  ...
  DirContainsProtos('phd/experimental/polyglot/baseline/clone_lists',
                    scrape_repos_pb2.LanguageCloneList)


def test_corpuses_are_valid():
  """Test that corpuses are valid."""
  DirContainsProtos('phd/experimental/polyglot/baseline/corpuses',
                    corpus_pb2.Corpus)


def test_models_are_valid():
  """Test that models are valid."""
  DirContainsProtos('phd/experimental/polyglot/baseline/models',
                    model_pb2.Model)


def test_samplers_are_valid():
  """Test that samplers are valid."""
  DirContainsProtos('phd/experimental/polyglot/baseline/samplers',
                    sampler_pb2.Sampler)
