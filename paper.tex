...
\begin{enumerate}
\setcounter{enumi}{-1}
\item \emph{Invalid test case} Program code + parameter combination is illegal, or some other failure. These are device specific; a test case which is valid on one platform may be invalid for another. We simply ignore this class of outcomes.
...
\subsection{cldrive: Arbitrary kernel execution}
