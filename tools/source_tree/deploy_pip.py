...
def FindPyLibraries(workspace: phd_workspace.PhdWorkspace,
                    root_package: str) -> typing.List[str]:
...
def GetUrlFromCnameFile(workspace: phd_workspace.PhdWorkspace,
                        package_root: str):
...
def _DoDeployPip(package_name: str, package_root: str,
                 classifiers: typing.List[str], description: str,
                 keywords: typing.List[str], license: str,
                 long_description_file: str, url: typing.Optional[str]):
...
"""
    ...
    fs.Write(workspace.workspace_root / deployment_package / 'BUILD',
             rules.encode('utf-8'))
...
def DEPLOY_PIP(package_name: str = None,
