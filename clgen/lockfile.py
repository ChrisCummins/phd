...
class UnableToAcquireLockError(clgen.CLgenError):
...
class UnableToReleaseLockError(clgen.CLgenError):
...
class LockFile:
    ...
    def acquire(self, force=False):
        ...
        """
        log.verbose("acquiring lock", self.path)
    ...
    def release(self, force=False):
        ...
        log.verbose("releasing lock", self.path)
