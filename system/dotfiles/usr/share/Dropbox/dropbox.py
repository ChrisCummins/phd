    ...
    with closing(DropboxCommand()) as dc:
      if options.list:
        ...
        def path_to_string(file_path):
          ...
          try:
            status = \
              dc.icon_overlay_file_status(path=file_path).get(u'status',
                                                              [None])[
                0]
        ...
        for file in args:
          ...
          try:
            status = \
              dc.icon_overlay_file_status(path=fp).get(u'status', [u'unknown'])[
                0]
