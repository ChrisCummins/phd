...
app.DEFINE_string(
  "find_bin",
  "find",
  "Path of `find` binary. Set this flag is find is not " "in the system $PATH.",
)
app.DEFINE_string(
  "ffmpeg_bin",
  "ffmpeg",
...
def MaybeTranscodeMp3(
  path: str, out_csv: csv.writer, max_bitrate: int = 192, lame_option: int = 3
) -> bool:
  """
