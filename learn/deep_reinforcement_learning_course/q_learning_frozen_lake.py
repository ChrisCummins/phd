...
app.DEFINE_integer(
  "q_learning_seed", None, "Random seed to initialize Q learning."
)
app.DEFINE_integer(
  "total_training_episodes", 10000, "The total number of episodes to train for."
)
app.DEFINE_float("q_learning_rate", 0.8, "Initial Q learning rate.")
app.DEFINE_integer(
  "max_steps_per_episode", 99, "The maximum steps per episode."
)
app.DEFINE_float("q_learning_gamma", 0.95, "Q learning discounting rate.")
app.DEFINE_float(
  "q_learning_init_epsilon", 1.0, "Initial Q learning exploration rate."
)
app.DEFINE_float(
  "q_learning_min_epsilon", 0.01, "Minimum Q learning exploration rate."
)
...
def Train(
  ...
  app.Log(
    ...
    humanize.Commas(total_episodes),
    humanize.Commas(max_steps),
    learning_rate,
    decay_rate,
    init_epsilon,
    min_epsilon,
  ...
  app.Log(
    1,
    "State space size: %s, action space size: %s. Q table: %dx%d.",
    humanize.Commas(env.observation_space.n),
    humanize.Commas(env.action_space.n),
