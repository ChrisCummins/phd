  ...
  def Run(self, n: int):
    for i in range(n):
      ...
      app.Log(
        ...
        i,
        len(episode),
        episode[-1].observation.player_score,
        episode[-1].observation.dealer_score,
        episode[-1].reward,
      )
...
def main(argv):
  ...
  print(agent.pi[10:, :, 1])
  print(
    f"After {agent.num_episodes} iterations, "
