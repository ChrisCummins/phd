...
int main(int argc, char** argv) {
	...
	cl_kernel clKernel = CECL_KERNEL(clProgram,"spmv_jds_vec",&clStatus);
  ...
  input_vec( parameters->inpFiles[1],h_x_vector,dim);
	...
	*/
	...
	jds_ptr_int = CECL_BUFFER(clContext,CL_MEM_READ_ONLY,depth*sizeof(int),NULL,&clStatus);
	CHECK_ERROR("CECL_BUFFER")
	sh_zcnt_int = CECL_BUFFER(clContext,CL_MEM_READ_ONLY,nzcnt_len*sizeof(int),NULL,&clStatus);
	CHECK_ERROR("CECL_BUFFER")
	...
	clStatus = CECL_SET_KERNEL_ARG(clKernel,7,sizeof(cl_mem),&sh_zcnt_int);
        CHECK_ERROR("CECL_SET_KERNEL_ARG")
	clStatus = CECL_SET_KERNEL_ARG(clKernel,8,sizeof(int),&warp_size);
        CHECK_ERROR("CECL_SET_KERNEL_ARG")
